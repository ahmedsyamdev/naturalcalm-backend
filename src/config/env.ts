...
class EnvValidator {
  ...
  private static validateNumber(key: string, value: string | undefined): number {
  ...
  static validate(): EnvConfig {
    return {
      ...
      MONGODB_URI: this.validateRequired('MONGODB_URI', process.env.MONGODB_URI),
      JWT_SECRET: this.validateRequired('JWT_SECRET', process.env.JWT_SECRET),
      JWT_REFRESH_SECRET: this.validateRequired('JWT_REFRESH_SECRET', process.env.JWT_REFRESH_SECRET),
      JWT_EXPIRE: this.validateRequired('JWT_EXPIRE', process.env.JWT_EXPIRE),
      JWT_REFRESH_EXPIRE: this.validateRequired('JWT_REFRESH_EXPIRE', process.env.JWT_REFRESH_EXPIRE),
